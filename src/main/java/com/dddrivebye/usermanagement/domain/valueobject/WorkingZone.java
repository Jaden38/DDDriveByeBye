...
public final class WorkingZone {

    private final String label;
    private final GeoCoordinates center;
    private final double radiusKm;

    private WorkingZone(String label, GeoCoordinates center, double radiusKm) {
        this.label = label;
        this.center = center;
        this.radiusKm = radiusKm;
    }

    public static WorkingZone of(String label, GeoCoordinates center, double radiusKm) {
        ...
        return new WorkingZone(label, center, radiusKm);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WorkingZone that)) return false;
